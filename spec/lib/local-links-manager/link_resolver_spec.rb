  ...
  describe "#resolve" do
    ...
    context "with interaction" do
      ...
      it "returns a link for matching service and interaction" do
        link = create(:link, local_authority:, service_interaction:)
      ...
      context "with a parent" do
        ...
        it "returns a link for matching parent service and interaction" do
          link = create(:link, local_authority: parent, service_interaction:)
        ...
        it "returns nil if matching parent has no valid tier for the service" do
          ...
          create(:link, local_authority: parent, service_interaction:)
    ...
    context "without interaction" do
      ...
      context "there are 2 links" do
        ...
        let(:service_interaction1) { create(:service_interaction, service:, interaction: interaction1) }
        let(:service_interaction2) { create(:service_interaction, service:, interaction: interaction2) }
        let!(:link1) { create(:link, local_authority:, service_interaction: service_interaction1) }
        let!(:link2) { create(:link, local_authority:, service_interaction: service_interaction2) }
      ...
      context "there is only one link" do
        let(:service_interaction) { create(:service_interaction, service:) }
